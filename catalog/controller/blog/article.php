...
class ControllerBlogArticle extends Controller
{
	...
	public function index()
	{
		...
		if ($article_info) {
			...
			$data['image'] = $this->model_tool_image->resize($article_info['image'], $this->config->get('configblog_image_article_page_width'), $this->config->get('configblog_image_article_page_height'));
			$data['date'] = date("F j, Y", strtotime($article_info['date_added']));
