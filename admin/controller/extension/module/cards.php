    ...
    public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            if (!isset($this->request->get['module_id'])) {
                $module_id = $this->{'model_' . $this->model_place . '_module'}->addModule('cards', $this->request->post);
            } else {
            ...
            if (isset($this->request->post['apply']) && $module_id) {
                $this->response->redirect($this->url->link('extension/module/cards', $this->token_var . '=' . $this->session->data[$this->token_var] . '&module_id=' . $module_id, true));
            } else {
        ...
        if (!isset($this->request->get['module_id'])) {
            $data['breadcrumbs'][] = array(
                'text' => $heading_title,
                'href' => $this->url->link('extension/module/cards', $this->token_var . '=' . $this->session->data[$this->token_var], true)
            );
        } else {
            $data['breadcrumbs'][] = array(
                'text' => $heading_title,
                'href' => $this->url->link('extension/module/cards', $this->token_var . '=' . $this->session->data[$this->token_var] . '&module_id=' . $this->request->get['module_id'], true)
            );
        }
        ...
        if (!isset($this->request->get['module_id'])) {
            $data['action'] = $this->url->link('extension/module/cards', $this->token_var . '=' . $this->session->data[$this->token_var], true);
        } else {
            $data['action'] = $this->url->link('extension/module/cards', $this->token_var . '=' . $this->session->data[$this->token_var] . '&module_id=' . $this->request->get['module_id'], true);
        }
        ...
        $data['image_height'] = $this->request->post['image_height'] ?? $this->config->get('image_height');
        $data['image_width'] = $this->request->post['image_width'] ?? $this->config->get('image_width');

        $data['header'] = $this->load->controller('common/header');
        $data['column_left'] = $this->load->controller('common/column_left');
        $data['footer'] = $this->load->controller('common/footer');

        $this->response->setOutput($this->load->view('extension/module/cards', $data));
    }

    protected function validate() {
        if (!$this->user->hasPermission('modify', 'extension/module/cards')) {
