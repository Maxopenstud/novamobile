...
class ControllerBlogSetting extends Controller {
	...
	public function index() {
		...
		$data['configblog_image_article_page_width'] = $this->request->post['configblog_image_article_page_width'] ?? $this->config->get('configblog_image_article_page_width') ?? 0;
		$data['configblog_image_article_page_height'] = $this->request->post['configblog_image_article_page_height'] ?? $this->config->get('configblog_image_article_page_height') ?? 0;
